...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvHistory,
      @NonNull Toolbar toolbar, @NonNull TextView tvEmpty, @NonNull TextView tvStats) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((LinearLayout) rootView, rvHistory, toolbar, tvEmpty,
          tvStats);
    }
